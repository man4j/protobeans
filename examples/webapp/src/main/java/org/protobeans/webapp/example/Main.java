...
@EnablePostgreSql(showSql = "false", schema = "demo", dbHost = "127.0.0.1", dbPort = "5432", user = "postgres", password = "changeme", basePackages = {"org.protobeans.webapp.example"}, migrationsPath = "migrations")
