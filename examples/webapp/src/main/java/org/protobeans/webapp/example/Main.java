...
@EnablePostgreSql(showSql = "false", schema = "postgres", dbHost = "${postgresIp}", dbPort = "${postgresPort}", user = "postgres", password = "PassWord123", basePackages = {"org.protobeans.webapp.example"}, migrationsPath = "migrations")
