...
@EnablePerconaContainer(imageTag = "5.7.16.14", schema = "test_db", rootPassword = "testpass", skipInit = true, exposeSchemaAs = "schema", exposeUrlAs = "url", exposePasswordAs = "password")
